    ...
    switch (currentPage) {
      ...
      case 'testimonials':
        return (
          <>
            <SEOHead
              title="Casos de Sucesso - Eleve Leads"
              description="Veja os resultados reais de nossos clientes."
              keywords="casos de sucesso, depoimentos clientes, resultados comprovados"
      ...
      case 'services':
        return (
          <>
            <SEOHead
              title="Serviços - Eleve Leads"
              description="Conheça nossos serviços especializados."
              keywords="serviços marketing digital, google meu negócio, seo local"
