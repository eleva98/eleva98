    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-16">
            ...
            <button 
              ...
              className="bg-blue-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg hover:bg-blue-700 transition-colors font-medium text-base md:text-lg inline-flex items-center space-x-2 group"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center group">
                <div className="bg-blue-100 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:bg-blue-600 transition-colors duration-300">
                  <benefit.icon className="w-8 h-8 md:w-10 md:h-10 text-blue-600 group-hover:text-white transition-colors duration-300" />
                </div>
            ...
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-5 md:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center mb-4 md:mb-6">
                  <div className="bg-blue-100 p-3 md:p-4 rounded-xl mr-3 md:mr-4">
          ...
          <div className="grid md:grid-cols-4 gap-5 md:gap-8">
            {process.map((step, index) => (
              <div key={index} className="text-center">
                <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-5 md:gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white rounded-xl p-5 md:p-8 shadow-lg">
                ...
                <p className="text-gray-700 mb-4 md:mb-6 leading-relaxed italic">
                  "{testimonial.quote}"
                </p>
      ...
      <section id="contact" className="py-10 md:py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center space-x-4 md:space-x-8 text-blue-100">
            <div className="flex items-center space-x-2">
