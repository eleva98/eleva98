...
const FinalCTA = () => {
  ...
  return (
    <section id="contact" className="py-10 md:py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">
            Pronto para <span className="text-yellow-400">Elevar seus Leads</span>?
          </h2>
          <p className="text-base md:text-xl text-blue-100 max-w-3xl mx-auto mb-6 md:mb-8">
            Agende uma conversa de 15 minutos, sem compromisso, e receba um diagnóstico gratuito completo do seu perfil no Google.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-blue-100">
            <div className="flex items-center space-x-2">
              <Clock className="w-4 h-4 md:w-5 md:h-5" />
              <span className="text-sm md:text-base">Resposta em até 2 horas úteis</span>
            </div>
            <div className="flex items-center space-x-2">
              <Phone className="w-4 h-4 md:w-5 md:h-5" />
              <span className="text-sm md:text-base">Análise 100% gratuita</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-4 md:space-y-6">
            <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">O que você receberá na análise:</h3>
            <div className="space-y-3 md:space-y-4">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-green-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm md:text-lg text-blue-50">{benefit}</span>
                </div>
              ))}
            </div>
            <div className="bg-blue-500 bg-opacity-50 rounded-lg p-4 md:p-6 mt-6 md:mt-8">
              <h4 className="font-bold text-base md:text-lg mb-2">💡 Bônus Especial</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2.5 md:px-4 md:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 text-sm md:text-base"
              ...
              <div>
                <label htmlFor="company" className="block text-sm font-medium text-gray-700 mb-1.5 md:mb-2">
                  Nome da Empresa *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="city" className="block text-sm font-medium text-gray-700 mb-1.5 md:mb-2">
                  Cidade (Opcional)
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="sector" className="block text-sm font-medium text-gray-700 mb-1.5 md:mb-2">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 md:py-4 rounded-lg hover:bg-blue-700 transition-colors font-bold text-base md:text-lg flex items-center justify-center space-x-2 group disabled:opacity-50 disabled:cursor-not-allowed"
              >
