    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-10 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 md:mb-12">
            <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Nossa Missão</h2>
            <div className="w-24 h-1 bg-blue-600 mx-auto mb-8"></div>
          </div>
          <div className="bg-gray-50 rounded-2xl p-5 md:p-8 lg:p-12">
            <p className="text-sm md:text-lg text-gray-700 leading-relaxed text-center">
      ...
      <section className="py-10 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 md:mb-12">
            <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Nossa Expertise e Diferencial</h2>
          ...
          <div className="space-y-6 md:space-y-12">
            ...
            <div className="grid md:grid-cols-3 gap-5 md:gap-8">
              <div className="bg-white rounded-xl p-6 shadow-lg text-center">
                ...
                <h3 className="text-base md:text-xl font-bold text-gray-900 mb-3">Certificação Google</h3>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg text-center">
                ...
                <h3 className="text-base md:text-xl font-bold text-gray-900 mb-3">Resultados Comprovados</h3>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg text-center">
                ...
                <h3 className="text-base md:text-xl font-bold text-gray-900 mb-3">Foco em Parcerias</h3>
      ...
      <section className="py-10 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Como Trabalhamos</h2>
            <div className="w-24 h-1 bg-blue-600 mx-auto mb-8"></div>
          ...
          <div className="grid md:grid-cols-3 gap-5 md:gap-8">
            <div className="text-center group">
              <div className="bg-blue-100 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-blue-600 transition-colors duration-300">
                <Eye className="w-8 h-8 md:w-10 md:h-10 text-blue-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-base md:text-xl font-bold text-gray-900 mb-4">Transparência Total</h3>
            ...
            <div className="text-center group">
              <div className="bg-green-100 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-green-600 transition-colors duration-300">
                <BarChart3 className="w-8 h-8 md:w-10 md:h-10 text-green-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-base md:text-xl font-bold text-gray-900 mb-4">Estratégia Baseada em Dados</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              <div className="bg-purple-100 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-purple-600 transition-colors duration-300">
                <DollarSign className="w-8 h-8 md:w-10 md:h-10 text-purple-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-base md:text-xl font-bold text-gray-900 mb-4">Obsessão por ROI</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-10 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Nossa Evolução no Mercado</h2>
            <div className="w-24 h-1 bg-blue-600 mx-auto mb-8"></div>
            ...
            <div className="space-y-6 md:space-y-12">
              <div className="flex items-center">
                <div className="flex-1 text-right pr-8">
                  <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h3 className="text-base md:text-lg font-bold text-gray-900 mb-2">2020</h3>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 text-left pl-8">
                  <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h3 className="text-base md:text-lg font-bold text-gray-900 mb-2">2021</h3>
              ...
              <div className="flex items-center">
                <div className="flex-1 text-right pr-8">
                  <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h3 className="text-base md:text-lg font-bold text-gray-900 mb-2">2022</h3>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 text-left pl-8">
                  <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h3 className="text-base md:text-lg font-bold text-gray-900 mb-2">2024</h3>
