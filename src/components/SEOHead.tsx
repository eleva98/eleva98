...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  React.useEffect(() => {
    ...
    // Update hreflang for Portuguese
    try {
      let hreflangLink = document.querySelector('link[hreflang="pt-BR"]');
      if (!hreflangLink) {
        hreflangLink = document.createElement('link');
        hreflangLink.setAttribute('rel', 'alternate');
        hreflangLink.setAttribute('hreflang', 'pt-BR');
        document.head.appendChild(hreflangLink);
      }
      hreflangLink.setAttribute('href', canonical);
    } catch (error) {
      console.warn('Erro ao atualizar hreflang:', error);
    }
